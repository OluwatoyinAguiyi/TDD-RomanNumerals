...
public class RomanNumeralsTest {
	...
	@Test
	public void convertFromDecimal0ToRomanNumeral() {
		String result = rn.convertToRomanNumeral(0);
		assertThat(result, equalTo(""));
	}

	@Test
	public void convertFromDecimal1ToRomanNumeral() {
		String result = rn.convertToRomanNumeral(1);
